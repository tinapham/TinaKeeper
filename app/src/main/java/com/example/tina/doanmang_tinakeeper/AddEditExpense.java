...
//        txtDate.setOnClickListener(showDatePicker);
        ...
        textDate=dft.format(cal.getTime());
...
//        }
    ...
    public void buttonSaveClicked(View view)  {
        ...
        int money = Integer.parseInt(this.txtMoney.getText().toString());
//        textDate = this.txtDate.getText().toString();
...
//
//        this.expense= new Expense(id,category,note,money,date);
